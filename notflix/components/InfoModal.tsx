...
// Define the props interface for the InfoModal component
...
const InfoModal: React.FC<InfoModalProps> = ({ visible, onClose }) => {
  ...
  // Custom hook to fetch movie information based on the movieId
  const { movieId } = useInfoModal();
  const { data = {} } = useMovie(movieId);

  // Effect to update modal visibility based on props
  useEffect(() => {
